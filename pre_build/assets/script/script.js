...
(async () => {
    ...
    const svg = {
        ...
        loader: '<svg class="loader" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none"><path stroke="#fff" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M19 8a3 3 0 1 0 0-6 3 3 0 0 0 0 6Z"/><path stroke="#fff" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M14.02 2.2C13.36 2.07 12.69 2 12 2 6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10c0-.68-.07-1.35-.2-1.99"/></svg>',
        noInternet: '<svg xmlns="http://www.w3.org/2000/svg" width="98" height="84" fill="none"><path fill="#fff" fill-rule="evenodd" d="M50.936 61.214a15.631 15.631 0 0 1 9.236 4.478 4.2 4.2 0 0 0 5.97 0 4.188 4.188 0 0 0 0-5.96m-15.206 1.482 6.876-6.87a23.952 23.952 0 0 1 8.33 5.387m8.06-44.775-.91-.35C65.599 11.64 57.467 10.103 49 10.103c-17.806 0-34.616 6.916-47.255 19.543a4.188 4.188 0 0 0 0 5.96 4.204 4.204 0 0 0 5.97 0C18.785 24.547 33.437 18.555 49 18.555c5.54 0 10.959.808 16.25 2.301l2.464.695-10.681 10.672-.773-.14a39.94 39.94 0 0 0-7.148-.65c-12.194 0-23.604 4.674-32.08 13.25l-.006.007a4.188 4.188 0 0 0 0 5.96 4.204 4.204 0 0 0 5.97 0 36.9 36.9 0 0 1 22.602-10.647l4.18-.4-37.471 37.193-.002.002a4.188 4.188 0 0 0 .002 5.958 4.204 4.204 0 0 0 5.97 0l75.618-75.55a4.188 4.188 0 0 0 0-5.96 4.2 4.2 0 0 0-5.97 0L74.203 14.956Zm.915 35.693a4.2 4.2 0 0 0 5.97 0 4.188 4.188 0 0 0 0-5.96c-2.329-2.326-4.835-4.311-7.607-6.111l-6.146 6.14a37.035 37.035 0 0 1 7.783 5.931ZM48.663 82.765a5.352 5.352 0 0 0 5.354-5.347 5.351 5.351 0 0 0-5.354-5.348 5.35 5.35 0 0 0-5.354 5.348 5.351 5.351 0 0 0 5.354 5.347Zm40.141-59.497-5.993 5.988c2.669 1.873 5.16 4.038 7.474 6.35a4.2 4.2 0 0 0 5.97 0 4.188 4.188 0 0 0 0-5.96c-2.322-2.32-4.825-4.393-7.45-6.378Z" clip-rule="evenodd"/></svg>',
        serverNotRespond: '<svg xmlns="http://www.w3.org/2000/svg" width="100" height="77" fill="none"><path fill="#fff" d="m82.966 21.94-6.94 6.895c1.051-.209 2.102-.417 3.154-.417 7.676 0 13.88 6.164 13.88 13.791 0 7.626-6.204 13.79-13.88 13.79H48.686l-6.94 6.896H79.18c11.461 0 20.82-9.299 20.82-20.687 0-10.03-7.36-18.492-17.034-20.268ZM88.539 1.984a3.506 3.506 0 0 0-4.943 0l-10.83 10.657C68.56 8.358 62.356 5.955 55.73 7c-4.837-4.492-11.146-7-17.77-7-13.565 0-24.606 10.343-25.763 23.507C4.838 26.851 0 34.164 0 42.313 0 53.701 9.359 63 20.82 63h1.262l-8.097 8.044a3.452 3.452 0 0 0 0 4.91c.63.628 1.577 1.046 2.418 1.046.841 0 1.788-.313 2.419-1.045l69.505-69.06c1.578-1.358 1.578-3.656.212-4.91ZM20.925 56c-7.675 0-13.88-6.164-13.88-13.791 0-6.06 3.89-11.284 9.674-13.06 1.472-.418 2.418-1.776 2.418-3.343v-.21c0-10.343 8.517-18.701 18.928-18.701 5.257 0 10.41 2.298 13.985 6.164.841.94 2.209 1.358 3.47 1.045 1.052-.313 2.209-.418 3.155-.418a12.66 12.66 0 0 1 9.148 3.866L29.127 55.998 20.926 56Z"/></svg>',
        icon: {
            ...
            user: '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none"><path stroke="#9B9CB0" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M20.59 22c0-3.87-3.85-7-8.59-7s-8.59 3.13-8.59 7M12 12a5 5 0 1 0 0-10 5 5 0 0 0 0 10v0Z"/></svg>',
            input: {
            ...
            world: '<svg class="icon_world" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none"><path stroke="#fff" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M12 22c5.523 0 10-4.477 10-10S17.523 2 12 2 2 6.477 2 12s4.477 10 10 10Z"/><path stroke="#fff" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M8 3h1a28.424 28.424 0 0 0 0 18H8m7-18a28.425 28.425 0 0 1 0 18"/><path stroke="#fff" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M3 16v-1a28.424 28.424 0 0 0 18 0v1M3 9a28.424 28.424 0 0 1 18 0"/></svg>',
            search: '<svg class="icon_search" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="none"><path stroke="#9E9E9E" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="m14 14-2.99-2.996L14 14Zm-1.333-7A5.667 5.667 0 1 1 1.333 7a5.667 5.667 0 0 1 11.334 0v0Z"/></svg>',
            remove: '<svg class="icon_remove" xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="none"><path stroke="#121423" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M17.5 4.983a84.752 84.752 0 0 0-8.35-.416c-1.65 0-3.3.083-4.95.25l-1.7.166m4.583-.841.184-1.092c.133-.792.233-1.383 1.641-1.383h2.184c1.408 0 1.516.625 1.641 1.391l.184 1.084m2.791 3.475-.541 8.391c-.092 1.309-.167 2.325-2.492 2.325h-5.35c-2.325 0-2.4-1.016-2.492-2.325l-.541-8.391m4.316 6.133h2.775m-3.466-3.333h4.166"/></svg>',
            check: '<svg class="icon_reload" xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="none"><path stroke="#121423" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M7.592 4.233A8.35 8.35 0 0 1 10 3.875a7.223 7.223 0 0 1 7.225 7.225A7.223 7.223 0 0 1 10 18.325 7.223 7.223 0 0 1 2.775 11.1c0-1.483.45-2.867 1.217-4.017m4.975-5.416L6.558 4.433l2.809 2.05"/></svg>',
            plus: '<svg class="icon_plus" xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="none"><path stroke="#121423" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 10h10m-5 5V5"/></svg>',
            filter: '<svg class="icon_filter" xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="none"><path stroke="#121423" stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" stroke-width="1.5" d="M9.108 1.75 5 8.333M4.5 1.75h11c.917 0 1.667.75 1.667 1.667V5.25c0 .667-.417 1.5-.834 1.917l-3.583 3.166c-.5.417-.833 1.25-.833 1.917v3.583c0 .5-.334 1.167-.75 1.417L10 18c-1.083.667-2.583-.083-2.583-1.417v-4.416c0-.584-.334-1.334-.667-1.75L3.583 7.083c-.416-.416-.75-1.166-.75-1.666V3.5c0-1 .75-1.75 1.667-1.75Z"/></svg>',
            filterEdit: '<svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="none"><path stroke="#fff" stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" stroke-width="1.5" d="M11.175 17.325 10 18.083c-1.092.675-2.608-.083-2.608-1.433v-4.458c0-.592-.334-1.35-.675-1.767l-3.2-3.367c-.425-.425-.759-1.175-.759-1.683V3.442c0-1.009.759-1.767 1.684-1.767h11.116a1.69 1.69 0 0 1 1.684 1.683v1.85c0 .675-.425 1.517-.842 1.934m-2.583 3.183c.25.9.95 1.6 1.85 1.85m-1.434-2.267-2.95 2.95a1.027 1.027 0 0 0-.25.492l-.158 1.125c-.058.408.225.692.633.633l1.125-.158a.991.991 0 0 0 .492-.25l2.95-2.95c.508-.508.75-1.1 0-1.85-.742-.742-1.333-.5-1.842.008Z"/></svg>',
            columns: '<svg class="icon_columns" xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="none"><g clip-path="url(#a)"><path stroke="#121423" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M8.75 16.583V3.417c0-1.25-.533-1.75-1.858-1.75H3.525c-1.325 0-1.858.5-1.858 1.75v13.166c0 1.25.533 1.75 1.858 1.75h3.367c1.325 0 1.858-.5 1.858-1.75Zm9.583 0V3.417c0-1.25-.533-1.75-1.858-1.75h-3.367c-1.325 0-1.858.5-1.858 1.75v13.166c0 1.25.533 1.75 1.858 1.75h3.367c1.325 0 1.858-.5 1.858-1.75Z"/></g><defs><clipPath id="a"><path fill="#fff" d="M0 0h20v20H0z"/></clipPath></defs></svg>',
            add: '<svg class="icon_add" xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="none"><g clip-path="url(#a)"><path stroke="#121423" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M6.667 10h6.666M10 13.333V6.667M7.5 18.333h5c4.167 0 5.833-1.666 5.833-5.833v-5c0-4.167-1.666-5.833-5.833-5.833h-5c-4.167 0-5.833 1.666-5.833 5.833v5c0 4.167 1.666 5.833 5.833 5.833Z"/></g><defs><clipPath id="a"><path fill="#fff" d="M0 0h20v20H0z"/></clipPath></defs></svg>',
            premium: '<svg class="icon_premium" width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M8.79004 1.11359L10.1768 4.5038C10.3688 4.91474 10.5182 5.21343 11.0599 5.29878L15.0199 5.59747C16.62 5.68281 15.8733 6.8349 15.4679 7.15492L12.609 9.52312C12.097 9.97115 12.1183 9.92848 12.417 11.133L13.0144 13.7688C13.5478 15.4329 12.801 15.9023 11.3076 14.8782L8.6407 13.2568L8.4075 13.1361C8.16525 13.0108 7.87771 13.0089 7.63377 13.1308L7.38193 13.2568L4.71505 14.8782C3.22159 15.9023 2.47487 15.4329 3.00824 13.7688C3.00824 13.7688 3.39227 11.9766 3.84031 11.2726C4.23334 10.655 7.4246 9.41644 8.17133 8.75505C8.34201 8.62704 8.32067 8.39738 8.14999 8.30702C7.7873 8.115 6.27251 8.58437 3.62696 8.86173C3.12489 8.91436 2.8 8.78227 2.48381 8.5929L0.532084 7.15492C0.126718 6.8349 -0.620009 5.68281 0.98012 5.59747L4.94011 5.29878C5.48182 5.21343 5.63116 4.91474 5.82318 4.5038L7.20996 1.11359C7.48915 0.40258 8.49799 0.407769 8.79004 1.11359Z" fill="url(#paint0_linear_337_1972)"/><defs><linearGradient id="paint0_linear_337_1972" x1="1.46154" y1="0.582272" x2="20.0523" y2="1.91493" gradientUnits="userSpaceOnUse"><stop stop-color="#CF8AF0"/><stop offset="0.630208" stop-color="#A2A9E7"/><stop offset="1" stop-color="#5A849B"/></linearGradient></defs></svg>',
            cross: '<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="none"><g clip-path="url(#a)"><path stroke="#121423" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M2.657 2.343 8.314 8m5.657 5.657L8.314 8m0 0-5.657 5.657M8.314 8l5.657-5.657"/></g><defs><clipPath id="a"><path fill="#fff" d="M0 0h16v16H0z"/></clipPath></defs></svg>',
        },
        check: '<svg xmlns="http://www.w3.org/2000/svg" width="13" height="11" fill="none"><path stroke="#575B78" stroke-linecap="round" stroke-width="2" d="m1 5 3.823 3.93a1 1 0 0 0 1.53-.116l5.157-7.212"/></svg>',
    ...
    app.pages.resources.tabs.autoreg = {
        render: () => {
    ...
    app.pages.accounts.tabs.spam = {
        render: () => {
    
        }
    }
    
    app.pages.accounts.tabs.comment = {
        render: () => {
    
        }
    }
    
    app.pages.accounts.tabs.view = {
        render: () => {
    
        }
    }
    
    app.pages.accounts.tabs.reaction = {
        render: () => {
    
        }
    }
    
    app.pages.accounts.tabs.vote = {
        render: () => {
    
        }
    }
    
    app.pages.accounts.tabs.report = {
        render: () => {
